...
void mostraArvEmPreOrdem ( struct camposNo *pai);
void mostraArvEmPosOrdem ( struct camposNo *pai);
...
void mostraArvEmPreOrdem( struct camposNo *pai){
	...
	if(pai != NULL){
		printf("%i\n", pai->valor);
		mostraArvEmPreOrdem (pai->esq);
		mostraArvEmPreOrdem (pai->dir);
		}	
	}
*/
...
void mostraArvEmPosOrdem ( struct camposNo *pai){
	if(pai != NULL){
		mostraArvEmPosOrdem (pai->esq);
		mostraArvEmPosOrdem (pai->dir);
		printf("%i\n", pai->valor);
	}
}
